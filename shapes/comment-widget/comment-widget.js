...
const s_formId = 'ID HERE'; // The Google Form
const s_nameId = 'ID HERE'; // The Name field ID
const s_websiteId = 'ID HERE'; // The Website field ID
const s_textId = 'ID HERE'; // The Text field ID
const s_pageId = 'ID HERE'; // The Page field ID
const s_replyId = 'ID HERE'; // The Reply field ID
const s_sheetId = 'ID HERE'; // The Google Sheet
